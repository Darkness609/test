...
2	TravelPlans	ข้อมูลแผนการท่องเที่ยว
3	Places	ข้อมูลสถานที่ท่องเที่ยว
4	Accommodations	ข้อมูลที่พัก
5	Activities	ข้อมูลกิจกรรมการท่องเที่ยว
6	Transportation	ข้อมูลการเดินทาง
7	UserInterests	ข้อมูลความสนใจของผู้ใช้
8	PlanDetails	ข้อมูลรายละเอียดแผนการท่องเที่ยว
